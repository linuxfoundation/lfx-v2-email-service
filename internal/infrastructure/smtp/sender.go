...
func (s *SMTPSender) Send(ctx context.Context, req api.SendEmailRequest) (emailID, groupID string, err error) {
	...
	msg := buildEmailMessage(req.To, req.Subject, req.HTML, req.Text, fromAddr, fromDisplayName, req.ReplyTo, s.cfg.ConfigurationSet, trackingID, req.ListUnsubscribeURL, req.ListUnsubscribePost)
